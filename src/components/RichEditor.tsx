...
export function RichEditor({ initialContent, onChange }: RichEditorProps) {
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden">
      {/* Toolbar - Centered Glass Island */}
      <div className="sticky top-0 z-20 w-full max-w-4xl mx-auto px-4 sm:px-8 md:px-10 pt-4 pb-2 shrink-0">
        <div className="bg-white/40 dark:bg-[#0a0a0a]/40 backdrop-blur-xl rounded-2xl shadow-lg border border-white/20 dark:border-white/10 flex items-center gap-0.5 px-3 py-1.5 flex-wrap">
